...
<a href="{{ route('forum.show', $thread->slug) }}"
   class="block bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-4 hover:shadow-md hover:border-gray-200 dark:hover:border-gray-600 transition group">
    <div class="flex items-start gap-4">
        ...
        <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2 mb-1.5 flex-wrap">
                ...
                @endif
                @if($thread->is_locked)
                    <span class="inline-flex items-center gap-1 px-2 py-0.5 text-[10px] font-semibold rounded-full bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400">
            ...
            {{-- Title --}}
            <h3 class="text-sm font-semibold text-gray-900 dark:text-white group-hover:text-blue-600 transition line-clamp-2">
                {{ $thread->title }}
            </h3>
            ...
            <div class="flex items-center gap-3 mt-2 text-xs text-gray-400 dark:text-gray-500">
                <span class="flex items-center gap-1">
                    <div class="w-4 h-4 rounded-full bg-gray-200 dark:bg-gray-600 flex items-center justify-center text-[8px] font-bold text-gray-500 dark:text-gray-300">
