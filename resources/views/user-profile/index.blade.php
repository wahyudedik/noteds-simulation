            ...
            <div class="mt-6">
                ...
                @if($activeTab === 'collections')
                    @if(isset($data['collections']) && $data['collections']->count() > 0)
                        ...
                        <div class="mt-6">
                            {{ $data['collections']->withQueryString()->links() }}
                        </div>
                    @else
                        <div class="text-center py-16">
                    ...
                    <div class="mb-6" x-data="{ forumTab: 'threads' }">
                        <div class="flex gap-1 border-b border-gray-200 dark:border-gray-700 mb-4">
                            <button @click="forumTab = 'threads'"
                                ...
                                :class="forumTab === 'threads' ? 'border-blue-600 text-blue-600 dark:text-blue-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'">
                                Thread Saya ({{ $stats['forum_threads'] }})
                            </button>
                            <button @click="forumTab = 'replies'"
                                class="px-4 py-2 text-sm font-medium border-b-2 transition"
                                :class="forumTab === 'replies' ? 'border-blue-600 text-blue-600 dark:text-blue-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'">
