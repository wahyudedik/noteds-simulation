<x-studio-layout title="Pengaturan Pembayaran">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl shadow-sm">
            <div class="p-6">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Pengaturan Pembayaran</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Atur metode pembayaran yang ingin digunakan untuk menerima payout dari revenue iklan.</p>
                ...
                <form method="POST" action="{{ route('studio.payment-settings.update') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <label class="relative cursor-pointer">
                                ...
                                <div class="border-2 border-gray-200 dark:border-gray-600 rounded-lg p-4 text-center peer-checked:border-blue-600 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 transition">
                                    <svg class="w-6 h-6 mx-auto mb-1 text-gray-400 dark:text-gray-500 peer-checked:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
                                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Bank Transfer</p>
                                </div>
                            </label>
                            <label class="relative cursor-pointer">
                                <input type="radio" name="preferred_method" value="paypal" {{ $settings->preferred_method === 'paypal' ? 'checked' : '' }} class="peer sr-only">
                                <div class="border-2 border-gray-200 dark:border-gray-600 rounded-lg p-4 text-center peer-checked:border-blue-600 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 transition">
                                    <svg class="w-6 h-6 mx-auto mb-1 text-gray-400 dark:text-gray-500 peer-checked:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300">PayPal</p>
                                </div>
                            </label>
                            <label class="relative cursor-pointer">
                                ...
                                <div class="border-2 border-gray-200 dark:border-gray-600 rounded-lg p-4 text-center peer-checked:border-blue-600 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 transition">
                                    <svg class="w-6 h-6 mx-auto mb-1 text-gray-400 dark:text-gray-500 peer-checked:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
                                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Midtrans</p>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div id="bank-fields" class="space-y-4 mb-6 {{ $settings->preferred_method !== 'bank_transfer' ? 'hidden' : '' }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="account_number" value="{{ $settings->account_number }}" placeholder="contoh: 1234567890"
                                class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm font-mono">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Atas Nama Rekening</label>
                    ...
                    <div id="paypal-fields" class="space-y-4 mb-6 {{ $settings->preferred_method !== 'paypal' ? 'hidden' : '' }}">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">PayPal Email</label>
                    ...
                    <div id="midtrans-fields" class="mb-6 {{ $settings->preferred_method !== 'midtrans' ? 'hidden' : '' }}">
                        <div class="p-4 bg-blue-50 border border-blue-200 dark:bg-blue-900/20 dark:border-blue-800 rounded-lg text-sm text-blue-700 dark:text-blue-400">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('studio.payouts') }}" class="px-6 py-2.5 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg transition">
                            Kembali
                        </a>
                    </div>
                </form>
