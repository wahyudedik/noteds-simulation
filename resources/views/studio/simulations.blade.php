                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center gap-2 pt-2 border-t border-gray-100">
                            ...
                            <form method="POST" action="{{ route('studio.simulations.destroy', $sim->slug) }}" id="delete-sim-{{ $sim->slug }}">
                                @csrf
                                @method('DELETE')
                                <button type="button" onclick="confirmSubmit(this.closest('form'), 'Yakin ingin menghapus experience ini? Tindakan ini tidak dapat dibatalkan.', { title: 'Hapus Experience', confirmText: 'Ya, Hapus' })" class="px-2 py-1.5 text-xs text-gray-400 hover:text-red-500 transition" title="Hapus">
