                ...
                <div class="bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden hover:shadow-md transition">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center gap-2 pt-2 border-t border-gray-100">
                            ...
                            @endif
                            <form method="POST" action="{{ route('studio.simulations.destroy', $sim->slug) }}" onsubmit="return confirm('Yakin ingin menghapus simulasi ini? Tindakan ini tidak dapat dibatalkan.')">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="px-2 py-1.5 text-xs text-gray-400 hover:text-red-500 transition" title="Hapus">
