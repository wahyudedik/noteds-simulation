                ...
                <form action="{{ route('marketplace.index') }}" method="GET" class="max-w-2xl">
                    <div class="relative">
                        <input
                            ...
                            class="w-full pl-12 pr-4 py-3 rounded-xl text-gray-900 dark:text-white bg-white/95 dark:bg-gray-800/95 backdrop-blur border-0 shadow-lg focus:ring-2 focus:ring-emerald-300 text-sm"
                        />
