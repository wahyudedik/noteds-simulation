        ...
        <div class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-4">
                ...
                @if(config('app.social.twitter'))
                    <a href="{{ config('app.social.twitter') }}" target="_blank" rel="noopener noreferrer" class="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition" aria-label="Twitter / X">
                ...
                @if(config('app.social.instagram'))
                    <a href="{{ config('app.social.instagram') }}" target="_blank" rel="noopener noreferrer" class="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition" aria-label="Instagram">
                ...
                @if(config('app.social.github'))
                    <a href="{{ config('app.social.github') }}" target="_blank" rel="noopener noreferrer" class="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition" aria-label="GitHub">
