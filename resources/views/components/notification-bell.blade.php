...
@auth
    <a href="{{ route('notifications.index') }}" class="relative text-gray-500 hover:text-gray-700 dark:hover:text-gray-200 transition min-h-[44px] min-w-[44px] flex items-center justify-center" title="Notifikasi" aria-label="Notifikasi">
