    ...
    <div class="hero-gradient-creator text-white py-16 md:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="text-3xl md:text-5xl font-bold mb-4 leading-tight">
                Buat Experience. Bagikan Ilmu.<br>
            ...
            <p class="text-gray-300 text-lg max-w-2xl mx-auto mb-8">
                Noteds bukan hanya tempat belajar — tempat para guru, dosen, mahasiswa, pelajar, dan kreator edukasi berbagi interactive experience kepada dunia.
            </p>
    ...
    <main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 dark:bg-gray-900">
        ...
        <section class="mb-20">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                @foreach([
                    ['title' => 'Buat Interactive Experience', 'desc' => 'Kembangkan pengalaman interaktif edukasi menggunakan HTML, CSS, dan JavaScript. Unggah file ZIP melalui Simulation Studio.'],
                    ['title' => 'Upload ke Simulation Studio', 'desc' => 'Upload paket experience, tambahkan judul, deskripsi, kategori, dan thumbnail yang menarik.'],
                    ['title' => 'Review oleh Tim Noteds', 'desc' => 'Experience akan melalui auto-scan keamanan dan review oleh tim kami untuk memastikan kualitas.'],
                    ['title' => 'Publikasikan ke Dunia', 'desc' => 'Setelah disetujui, experience dipublikasikan dan dapat ditemukan oleh jutaan pengguna.'],
        ...
        <section class="mb-20">
            ...
            @php
                $dashboardIcons = [
                    ...
                    ['svg' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>', 'label' => 'Experience Terpopuler'],
        ...
        <section class="mb-20">
            ...
            @php
                $whyIcons = [
                    ['svg' => '<svg class="w-7 h-7" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>', 'title' => 'Karyamu Dipelajari Banyak Orang', 'desc' => 'Experiencemu dapat diakses oleh jutaan pengguna dari seluruh Indonesia.'],
                    ['svg' => '<svg class="w-7 h-7" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"/></svg>', 'title' => 'Bangun Portofolio Edukasi', 'desc' => 'Kumpulkan karya experience terbaikmu dalam satu profil kreator yang profesional.'],
        ...
        <section class="mb-20">
            <div class="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-8 md:p-12 text-white text-center">
                ...
                <p class="text-gray-300 text-lg max-w-3xl mx-auto mb-8 leading-relaxed">
                    Kami ingin membangun ekosistem experience edukasi terbesar, tempat jutaan pengguna belajar melalui interactive experience dan ribuan kreator berbagi karya terbaik mereka.
                </p>
                <div class="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto text-left">
                    <div class="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10">
                        ...
                        <p class="text-white font-medium">Belajar dengan mencoba, mengeksplorasi, dan memahami konsep secara langsung melalui interactive experience.</p>
                    </div>
                    <div class="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10">
                        <p class="text-purple-300 font-medium mb-2">Rumah bagi Kreator Experience</p>
                        <p class="text-gray-400 text-sm">Seperti YouTube menjadi rumah bagi kreator video, Noteds menjadi rumah bagi kreator experience edukasi.</p>
                    </div>
                    <div class="bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10">
