<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            {{-- Simulations Grid --}}
            <div class="mt-8">
                <h2 class="text-xl font-bold text-gray-900 mb-4">Experience ({{ $simulations->count() }})</h2>
                ...
                @else
                    <div class="text-center py-16">
                        ...
                        <p class="text-gray-400 text-sm mt-2">Creator ini belum mengunggah experience apapun.</p>
                    </div>
                @endif
            </div>
        </div>
