    ...
    <template x-if="loading">
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="mb-4"><div class="h-4 bg-gray-200 dark:bg-gray-700 rounded w-28 animate-pulse"></div></div>
                <div class="flex gap-2 mb-6">
                    <div class="h-9 bg-gray-200 dark:bg-gray-700 rounded-lg w-20 animate-pulse"></div>
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl overflow-hidden">
                    <div class="space-y-0">
                        @for($i = 0; $i < 10; $i++)
                            <div class="flex items-center gap-4 p-4 border-b border-gray-100 dark:border-gray-700 animate-pulse">
