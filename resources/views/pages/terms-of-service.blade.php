@php
    $seo = [
        ...
        'description' => 'Syarat dan Ketentuan penggunaan ' . config('app.name') . ' - Pelajari aturan dan ketentuan yang berlaku saat menggunakan Layanan kami.',
...
<x-app-layout :$seo>
    <div class="py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Syarat & Ketentuan</h1>
            ...
            <div class="prose prose-gray dark:prose-invert max-w-none space-y-8">
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">1. Penerimaan Syarat</h2>
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">2. Kelayakan</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">3. Pendaftaran Akun</h2>
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">4. Konten Pengguna</h2>

                    <h3 class="text-lg font-medium text-gray-800 dark:text-gray-200 mt-4 mb-2">4.1 Kepemilikan Konten</h3>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <h3 class="text-lg font-medium text-gray-800 dark:text-gray-200 mt-4 mb-2">4.2 Tanggung Jawab Konten</h3>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">Anda bertanggung jawab penuh atas konten yang Anda unggah. Anda menjamin bahwa:</p>
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">5. Larangan Penggunaan</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">Anda dilarang untuk:</p>
                    <ul class="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-1.5 mt-2">
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">6. Program Kreator & Monetisasi</h2>

                    <h3 class="text-lg font-medium text-gray-800 dark:text-gray-200 mt-4 mb-2">6.1 Kelayakan Kreator</h3>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <h3 class="text-lg font-medium text-gray-800 dark:text-gray-200 mt-4 mb-2">6.2 Pembagian Pendapatan</h3>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <h3 class="text-lg font-medium text-gray-800 dark:text-gray-200 mt-4 mb-2">6.3 Pemrosesan Pembayaran</h3>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">7. Iklan</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                        ...
                        <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer" class="text-blue-600 dark:text-blue-400 hover:underline">policies.google.com</a>.
                    </p>
                </section>

                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">8. Hak Kekayaan Intelektual</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">9. Penafian Jaminan</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">10. Batasan Tanggung Jawab</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">11. Ganti Rugi</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">12. Penghentian Akun</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">13. Hukum yang Berlaku</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">14. Perubahan Syarat</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                <section>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">15. Hubungi Kami</h2>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
