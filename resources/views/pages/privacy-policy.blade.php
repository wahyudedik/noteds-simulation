    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="prose prose-gray max-w-none space-y-8">
            ...
            <section>
                ...
                <h3 class="text-lg font-medium text-gray-800 mt-4 mb-2">2.1 Informasi yang Anda Berikan</h3>
                ...
                <h3 class="text-lg font-medium text-gray-800 mt-4 mb-2">2.2 Informasi yang Dikumpulkan Secara Otomatis</h3>
                <ul class="list-disc list-inside text-gray-600 space-y-1.5">
                ...
                <h3 class="text-lg font-medium text-gray-800 mt-4 mb-2">2.3 Informasi dari Pihak Ketiga</h3>
                <ul class="list-disc list-inside text-gray-600 space-y-1.5">
                    ...
                    <li><strong>Iklan:</strong> Google AdSense dan mitra iklan lainnya dapat mengumpulkan data menggunakan cookie dan teknologi penelusuran. Informasi lebih lanjut tersedia di <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:underline">Kebijakan Iklan Google</a>.</li>
                </ul>
            </section>

            <section>
                <h2 class="text-xl font-semibold text-gray-900 mb-3">3. Penggunaan Informasi</h2>
            ...
            <section>
                ...
                <p class="text-gray-600 leading-relaxed">Kami tidak menjual informasi pribadi Anda. Kami dapat membagikan informasi dalam situasi berikut:</p>
                <ul class="list-disc list-inside text-gray-600 space-y-1.5 mt-2">
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-900 mb-3">5. Cookie dan Teknologi Pelacakan</h2>
                <p class="text-gray-600 leading-relaxed">Kami menggunakan cookie untuk:</p>
                <ul class="list-disc list-inside text-gray-600 space-y-1.5 mt-2">
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-900 mb-3">6. Keamanan Data</h2>
                <p class="text-gray-600 leading-relaxed">
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-900 mb-3">7. Hak Anda</h2>
                <p class="text-gray-600 leading-relaxed">Berdasarkan peraturan perlindungan data yang berlaku (termasuk GDPR dan UU PDP Indonesia), Anda memiliki hak untuk:</p>
                <ul class="list-disc list-inside text-gray-600 space-y-1.5 mt-2">
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-900 mb-3">8. Retensi Data</h2>
                <p class="text-gray-600 leading-relaxed">
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-900 mb-3">9. Perlindungan Anak</h2>
                <p class="text-gray-600 leading-relaxed">
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-900 mb-3">10. Perubahan Kebijakan</h2>
                <p class="text-gray-600 leading-relaxed">
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-900 mb-3">11. Hubungi Kami</h2>
                <p class="text-gray-600 leading-relaxed">
