                ...
                <form action="{{ route('admin.ads.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select name="ad_network" id="ad_network" class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
