                            ...
                            <table class="w-full text-sm">
                                <thead>
                                    <tr class="border-b border-gray-200 dark:border-gray-700">
                                        ...
                                        <th class="text-left py-3 px-2 text-gray-500 dark:text-gray-400 font-medium">Kreator</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 dark:bg-gray-700/50 dark:hover:bg-gray-600/50">
                                        ...
                                        <td class="py-3 px-2 text-gray-500 dark:text-gray-400">{{ $sim->user->name }}</td>
                                        ...
                                        <td class="py-3 px-2 text-right space-x-2">
                                            <a href="{{ route('admin.simulations.show', $sim) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-xs font-medium">Lihat</a>
                                            <a href="{{ route('admin.simulations.edit', $sim) }}" class="text-green-600 dark:text-green-400 hover:text-green-700 text-xs font-medium">Edit</a>
                                            <form action="{{ route('admin.simulations.destroy', $sim) }}" method="POST" class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" onclick="confirmSubmit(this.closest('form'), 'Yakin hapus experience ini?')" class="text-red-600 dark:text-red-400 hover:text-red-700 text-xs font-medium">Hapus</button>
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach
