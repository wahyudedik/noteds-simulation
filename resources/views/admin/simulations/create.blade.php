                        ...
                        <div>
                            ...
                            <div x-data="{ open: false }" class="mt-3">
                                <button type="button" @click="open = !open"
                                    class="inline-flex items-center gap-1.5 text-xs font-medium text-blue-600 dark:text-blue-400 hover:text-blue-800 transition">
                                ...
                                <div x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-1" x-cloak
                                    class="mt-3 p-4 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-700 rounded-lg text-xs">
...
+-- README.md              <span class="text-gray-400 dark:text-gray-500"># Dokumentasi teknis (opsional)</span></code></pre>
                                    ...
                                    <div class="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                                        <p class="font-semibold text-gray-700 dark:text-gray-300 mb-1">
                                            ...
                                            Format <code class="bg-gray-200 px-1.5 py-0.5 rounded">manifest.json</code> (opsional):
                                        </p>
  ...
  "entry_point": "index.html"
                                    ...
                                    <div class="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                                        <p class="text-gray-500 dark:text-gray-400 leading-relaxed">
                                            ...
                                            <strong>Catatan:</strong> File <code class="bg-gray-200 px-1.5 py-0.5 rounded">index.html</code> wajib ada sebagai entry point.
                                            Jika <code class="bg-gray-200 px-1.5 py-0.5 rounded">manifest.json</code> disertakan, metadata akan otomatis terisi dari file tersebut.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <a href="{{ route('admin.simulations.index') }}" class="px-6 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg transition">
                                Batal
                            </a>
                        </div>
                    </form>
