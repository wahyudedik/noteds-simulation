            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                ...
                <form method="POST" action="{{ route('admin.seo.store') }}">
                    ...
                    <div class="space-y-6">
                        {{-- Page Key --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Page Key <span class="text-red-500">*</span></label>
                            ...
                            <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Identifier unik halaman. Gunakan <code class="bg-gray-100 px-1 rounded">simulation:slug</code> untuk experience spesifik.</p>
                        </div>

                        {{-- Meta Title --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Meta Title <span class="text-red-500">*</span></label>
                        ...
                        {{-- Meta Description --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Meta Description <span class="text-red-500">*</span></label>
                        ...
                        <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Open Graph (Social Media)</h3>

                        {{-- OG Title --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">OG Title</label>
                        ...
                        {{-- OG Description --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">OG Description</label>
                        ...
                        <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Structured Data (Schema.org JSON-LD)</h3>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Format JSON valid. Kosongkan jika tidak diperlukan.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 mt-6">
                        ...
                        <a href="{{ route('admin.seo.index') }}" class="px-6 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg transition">
                            Batal
                        </a>
                    </div>
                </form>
