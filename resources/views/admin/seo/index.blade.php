                ...
                <div class="p-6">
                            ...
                            <table class="w-full text-sm">
                                <thead>
                                    <tr class="border-b border-gray-200 dark:border-gray-700">
                                        <th class="text-left py-3 px-2 text-gray-500 dark:text-gray-400 font-medium">Page Key</th>
                                        <th class="text-left py-3 px-2 text-gray-500 dark:text-gray-400 font-medium">Meta Title</th>
                                        <th class="text-left py-3 px-2 text-gray-500 dark:text-gray-400 font-medium">Meta Description</th>
                                        <th class="text-center py-3 px-2 text-gray-500 dark:text-gray-400 font-medium">Schema</th>
                                        <th class="text-left py-3 px-2 text-gray-500 dark:text-gray-400 font-medium">Updated By</th>
                                        <th class="text-left py-3 px-2 text-gray-500 dark:text-gray-400 font-medium">Updated</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b border-gray-100 hover:bg-gray-50 dark:bg-gray-700/50 dark:hover:bg-gray-600/50">
                                        <td class="py-3 px-2">
                                            <span class="inline-flex px-2 py-0.5 text-xs font-medium bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 rounded-full font-mono">{{ $seo->page_key }}</span>
                                        </td>
                                        <td class="py-3 px-2 text-gray-900 dark:text-white">{{ Str::limit($seo->meta_title, 40) }}</td>
                                        <td class="py-3 px-2 text-gray-500 dark:text-gray-400 text-xs">{{ Str::limit($seo->meta_description, 50) }}</td>
                                        <td class="py-3 px-2 text-center">
                                            @if($seo->structured_data)
                                                <span class="inline-flex px-2 py-0.5 text-xs font-medium bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 rounded-full">✓</span>
                                            @else
                                                <span class="text-gray-300">—</span>
                                            @endif
                                        </td>
                                        <td class="py-3 px-2 text-gray-500 dark:text-gray-400 text-xs">{{ $seo->updater?->name ?? '-' }}</td>
                    ...
                    @else
                        <div class="text-center py-8 text-gray-500 dark:text-gray-400">
                            ...
                            <p>Belum ada pengaturan SEO. <a href="{{ route('admin.seo.create') }}" class="text-blue-600 dark:text-blue-400 hover:underline">Tambah yang pertama!</a></p>
                        </div>
                    @endif
                </div>
            </div>
