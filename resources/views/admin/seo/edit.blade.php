            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                ...
                <form method="POST" action="{{ route('admin.seo.update', $seo) }}">
                    ...
                    <div class="space-y-6">
                        {{-- Page Key (Read Only) --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Page Key</label>
                            <div class="px-4 py-2.5 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-600 dark:text-gray-400 font-mono">{{ $seo->page_key }}</div>
                        </div>
