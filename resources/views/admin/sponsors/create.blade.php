                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="file" name="logo" id="logo" accept="image/*"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" />
                            <p class="text-xs text-gray-500 mt-1">Format: JPG, PNG, atau SVG. Maks 512KB.</p>
                        ...
                        <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                            <a href="{{ route('admin.sponsors.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition">Batal</a>
