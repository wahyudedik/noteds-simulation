                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <dl class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <dd class="font-medium text-gray-900 dark:text-white">{{ $report->user->name }}</dd>
                        </div>
                        <div>
                            <dt class="text-gray-500 dark:text-gray-400">Waktu</dt>
                            <dd class="font-medium text-gray-900 dark:text-white">{{ $report->created_at->format('d M Y, H:i') }}</dd>
                        </div>
                        <div>
            ...
            <div class="space-y-6">
                    ...
                    @if($report->status === 'pending')
                        <form method="POST" action="{{ route('admin.reports.review', $report) }}">
                            ...
                            <div class="space-y-3 mb-4">
                                ...
                                <label class="flex items-center gap-2 text-sm">
                                    <input type="radio" name="status" value="dismissed" class="text-gray-500 dark:text-gray-400">
                                    <span>Tolak Laporan</span>
                                </label>
                            </div>
                            <textarea name="action_taken" rows="3" class="w-full border border-gray-200 dark:border-gray-700 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 mb-3" placeholder="Catatan tindakan (opsional)..."></textarea>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('admin.simulations.edit', $report->simulation) }}" class="block w-full text-center px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-xl transition">
                            Edit Experience
                        </a>
                    </div>
                </div>
