<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-white">Security Scan Logs</h2>
    ...
    <div class="py-8 max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-x-auto">
            <table class="w-full text-sm min-w-[640px]">
                ...
                <tbody>
                    @forelse($logs as $log)
                        <tr class="border-b border-gray-50 dark:border-gray-700 hover:bg-gray-50 dark:bg-gray-700/50 dark:hover:bg-gray-600/50 transition">
                            <td class="px-5 py-4">
