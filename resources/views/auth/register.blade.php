<x-guest-layout>
    ...
    <div class="mb-8">
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Gabung dan mulai belajar dengan interactive experience</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="username" class="block mt-1 w-full rounded-xl"
                          type="text" name="username" :value="old('username')" required autocomplete="username" placeholder="contoh: john_doe" />
    ...
    <div class="mt-6 text-center">
        <p class="text-sm text-gray-600 dark:text-gray-400">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition">
                Masuk di sini
            </a>
        </p>
    </div>
