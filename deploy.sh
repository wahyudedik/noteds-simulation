...
# Step 6: Storage link & directories
echo -e "${BLUE}Step 6: Creating storage link & directories...${NC}"
php artisan storage:link --force 2>/dev/null || true
mkdir -p storage/app/simulations
mkdir -p storage/app/private/simulations
chmod -R 775 storage/app/simulations 2>/dev/null || true
echo -e "${GREEN}Storage link & directories ready.${NC}"
echo ""
